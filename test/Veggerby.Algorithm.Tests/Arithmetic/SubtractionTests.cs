...
namespace Veggerby.Algorithm.Tests.Arithmetic
{
    public class SubtractionTests
    {
        ...
        public class _Equals
        {
            ...
            {
                // arrange
                var v = new Subtraction(new Constant(1), new Constant(3));
            ...
            {
                // arrange
                var v1 = new Subtraction(new Constant(1), new Constant(3));
            ...
            public void Should_not_equal_different_operands()
            {
                // arrange
                var v1 = new Subtraction(new Constant(1), new Constant(3));
                var v2 = new Subtraction(new Constant(2), new Constant(2));
            ...
            public void Should_not_equal_mirrored_operands()
            {
                // arrange
                var v1 = new Subtraction(new Constant(1), new Constant(3));
                var v2 = new Subtraction(new Constant(3), new Constant(1));
