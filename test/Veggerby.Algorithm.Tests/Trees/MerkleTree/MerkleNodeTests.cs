...
public class MerkleNodeTests
{
    ...
    public void Should_initialize_merkle_tree()
    {
        ...
        actual.LeafNodeCount.Should().Be(7);
        actual.TotalNodeCount.Should().Be(13);
        n01.Hash.Should().BeEquivalentTo(n0.Hash.Concat(n1.Hash));
        n23.Hash.Should().BeEquivalentTo(n2.Hash.Concat(n3.Hash));
        n45.Hash.Should().BeEquivalentTo(n4.Hash.Concat(n5.Hash));
        n0123.Hash.Should().BeEquivalentTo(n0.Hash.Concat(n1.Hash).Concat(n2.Hash).Concat(n3.Hash));
        n012345.Hash.Should().BeEquivalentTo(n0.Hash.Concat(n1.Hash).Concat(n2.Hash).Concat(n3.Hash).Concat(n4.Hash).Concat(n5.Hash));
        actual.Hash.Should().BeEquivalentTo(n0.Hash.Concat(n1.Hash).Concat(n2.Hash).Concat(n3.Hash).Concat(n4.Hash).Concat(n5.Hash).Concat(n6.Hash));
    }
    ...
    public void Should_initialize_merkle_node_from_list()
    {
        ...
        // assert
        actual.Height.Should().Be(4);
        actual.LeafNodeCount.Should().Be(13);
    }
}