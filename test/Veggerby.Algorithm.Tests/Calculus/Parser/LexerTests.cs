...
public class LexerTests
{
    ...
    public void Should_get_only_end_no_definitions_no_content()
    {
        ...
        actual.Single().Type.Should().Be(TokenType.End);
    }
    ...
    public void Should_fail_invalid_token_dummy_lexer()
    {
        ...
        // act
        var actual = () => lexer.Tokenize("1234+123").ToList();

        // assert
        actual.Should().Throw<Exception>().WithMessage("*Unrecognized symbol '1' at index 0 (line 1, column 0).*");
    }
    ...
    public void Should_fail_invalid_token()
    {
        ...
        // act
        var actual = () => lexer.Tokenize("[").ToList();

        // assert
        actual.Should().Throw<Exception>().WithMessage("Unrecognized symbol '[' at index 0 (line 1, column 0).*");
    }
    ...
    public void Should_fail_invalid_token_in_body()
    {
        ...
        // act
        var actual = () => lexer.Tokenize("sin{1+x}").ToList();

        // assert
        actual.Should().Throw<Exception>().WithMessage("*Unrecognized symbol '{' at index 3 (line 1, column 3).*");
    }
}