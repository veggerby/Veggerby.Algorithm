...
{
    public readonly static Variable x = Create("x");
    public readonly static Variable y = Create("y");
    ...
    public bool Equals(Variable other) => other is not null && string.Equals(Identifier, other.Identifier);
