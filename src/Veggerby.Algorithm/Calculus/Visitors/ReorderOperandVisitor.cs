...
{
    private static Operand ReorderCommutativeBinaryOperation<TOperand>(TOperand operand, Func<IEnumerable<Operand>, Operand> factory) where TOperand : Operand, ICommutativeOperation
    {
