...
public class Matrix
{
    ...
    public static Matrix operator +(Matrix m1, Matrix m2)
    {
        ...
        {
            throw new ArgumentException("Cannot add matrices with different dimensions", nameof(m2));
        }
    ...
    public static Matrix operator *(Matrix m1, Matrix m2)
    {
        ...
        {
            throw new ArgumentException("m1 must have same number of columns as m2 has rows", nameof(m2));
        }
    ...
    public static Vector operator *(Matrix m, Vector v)
    {
        ...
        {
            throw new ArgumentException("m must have same number of columns as v has rows", nameof(v));
        }
